...
def read_cookbook():
    file_path = os.path.join(os.getcwd(), 'recipe_HW.txt')
    cook_book = {}
...
def get_shop_list_by_dishes(dishes, person_count):
    ...
    for dish_name in dishes:  # список полученных блюд
        if dish_name in cook_book:
            for ings in cook_book[dish_name]:  #  ингридиенты в блюде
                meas_quan_list = dict()
